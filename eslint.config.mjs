...
export default [
  ...
  },
  {
    rules: {
      ...
      '@typescript-eslint/explicit-module-boundary-types': 'warn', // Require explicit types for exported functions and parameters
      '@typescript-eslint/parameter-properties': 'warn', // Require explicit types for function parameters
